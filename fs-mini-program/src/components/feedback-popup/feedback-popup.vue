<template>
  <view class="fp-mask" v-if="show" @tap="close">
    <view class="fp-sheet" @tap.stop>
      ...
      <view class="fp-privacy">你的反馈仅用于优化服务者支持体系，不会用于商业推广。</view>
    </view>
  </view>
</template>
...
.fp-privacy { margin-top: 10rpx; text-align: center; font-size: 20rpx; color: var(--text-tertiary, #9a9a9a); line-height: 1.4; }
</style>
